...
void markov::_generate_text(int size) {
    ...
    /*string text1 = _model->generate(size);
    string text2 = _model->generate(size);
    string text3 = _model->generate(size);
    string text4 = _model->generate(size);*/
	_mark_stop();
